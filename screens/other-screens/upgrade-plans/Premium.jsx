    ...
    return(
        <View style={styles.container}>
            <View style={{paddingHorizontal: 20, paddingVertical: 20, borderBottomWidth: 1, borderColor: '#E5E5E5'}}>
                <Text style={{fontSize: 16, fontFamily: 'MontserratBold', lineHeight: 24}}>Premium</Text>      
                <Text style={{color: '#DE8E0E', fontSize: 14, fontFamily: 'OpenSansRegular', lineHeight: 24}}>$199.99/Year (33%)</Text>
            </View>
            ...
            <View style={styles.currentType}>
                {currentPlan === 'premium' ? <CurrentPlan /> : <SelectButton />}
            </View>
        </View>
    );
}
