...
import { EliteIcon } from "../../../assets/svg-icons/PlansIcons";
...
export default function Elite() {
  ...
  const options: Omit<FlutterwaveInitOptions, "redirect_url"> = {
    ...
    payment_plan: annually
      ? flw_plans.elite_yearly.id
      : flw_plans.elite_monthly.id,
    meta: {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.currentType}>
        {currentPlan === "elite" ? (
          ...
          <SelectButton
            onPress={() => upgrade("elite", annually ? "YEARLY" : "YEARLY")}
          />
        )}
      </View>
    </View>
